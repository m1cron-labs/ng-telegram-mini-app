...
export interface CloudStorage {
   ...
   * @param callback
   */
  setItem: (key: string, value: string, callback?: ((error: Error | null, stored?: boolean) => void) | Function) => CloudStorage;
   ...
   * @param callback
   */
  getItem: (key: string, callback: ((error: Error | null, value?: string | null) => void) | Function) => CloudStorage;
   ...
   * @param callback
   */
  getItems: (keys: string[], callback: ((error: Error | null, values?: Record<string, string>) => void) | Function) => CloudStorage;
   ...
   * @param callback
   */
  removeItem: (key: string, callback?: ((error: Error | null, removed?: boolean) => void) | Function) => CloudStorage;
   ...
   * @param callback
   */
  removeItems: (keys: string[], callback?: ((error: Error | null, removed?: boolean) => void) | Function) => CloudStorage;
   ...
   * @param callback
   */
  getKeys: (callback: ((error: Error | null, keys?: string[]) => void) | Function) => CloudStorage;
}
